...
const COMMAND_DEFINITIONS: BotCommandI18nDefinition[] = [
  ...
  { command: "disable", descriptionKey: "cmd.description.disable" },
  { command: "enable", descriptionKey: "cmd.description.enable" },
  { command: "deletesessions", descriptionKey: "cmd.description.deletesessions" },
